...
export default function Terms() {
    return (
        <div className="min-h-screen flex flex-col">
            {/* Header */}
            <header className="px-6 lg:px-24 py-5 flex items-center justify-between bg-foreground text-background">
                <Link href="/">
            ...
            <main className="flex-1 flex justify-center px-6">
                ...
                >
                    ...
                    <p>
                        ...
                        Freaks (“we”, “our”, or “the app”). By using the app,
                    ...
                    <section className="space-y-3">
                        ...
                        <p>Freaks is provided “as is” without warranties.</p>
            ...
            {/* Footer (optional consistency with other pages) */}
            <Footer />
        </div>
    );
}
