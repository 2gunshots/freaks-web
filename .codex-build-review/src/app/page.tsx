        ...
        <div className="h-screen w-screen overflow-hidden flex flex-col">
            ...
            <main className="flex-1 relative flex items-center justify-between">
                <div className="max-w-3xl z-10 pl-10 lg:pl-24">
                    ...
                    <div
                        // href="/membership"
                        className="pointer-events-none w-fit flex flex-row justify-between items-center gap-5 py-1 pr-1 pl-7 rounded-full bg-black text-white mt-10"
                    >
                        {/* Become a member */}
                        Coming Soon
                ...
                <div>
                    <div className="relative">
                        <Image
                            className="hidden md:block mix-blend-multiply z-10"
                            src="/images/art.png"
                            alt="Brand Art"
                            width={600}
                            height={600}
