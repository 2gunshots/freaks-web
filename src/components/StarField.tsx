    ...
    return (
        ...
        >
            <FlickerLayer
                ...
                duration={star.flickerLoopDuration}
                repeatDelay={star.flickerRepeatDelay}
            >
                <svg
                    width={star.size}
                    height={star.size}
            ...
            setStars((prev) => [
                ...prev,
                {
                    ...
                    flickerLoopDuration:
                        ...
                        Math.random() *
                            ((FLICKER_DELAY_MAX - FLICKER_DELAY_MIN) / 1000),
                    flickerRepeatDelay: Math.random() * 2,
                },
            ]);
